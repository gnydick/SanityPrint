...
set(DESKTOP_LINK_NAME "Sanity Print")
...
if(${PROJECT_VERSION_EXTRA} STREQUAL "Release")
    ...
    set(CPACK_NSIS_DISPLAY_NAME "${DESKTOP_LINK_NAME} ${SANITYPRINT_VERSION_MAJOR}.${SANITYPRINT_VERSION_MINOR}")
else()
    set(CPACK_NSIS_PACKAGE_NAME "${DESKTOP_LINK_NAME} ${SANITYPRINT_VERSION_MAJOR}.${SANITYPRINT_VERSION_MINOR} ${PROJECT_VERSION_EXTRA}")
    set(CPACK_NSIS_DISPLAY_NAME "${DESKTOP_LINK_NAME} ${SANITYPRINT_VERSION_MAJOR}.${SANITYPRINT_VERSION_MINOR} ${PROJECT_VERSION_EXTRA}")
endif()
if(${PROJECT_VERSION_EXTRA} STREQUAL "Release")
...
set (CPACK_PACKAGE_VERSION_MAJOR "${SANITYPRINT_VERSION_MAJOR}")
set (CPACK_PACKAGE_VERSION_MINOR "${SANITYPRINT_VERSION_MINOR}")
set (CPACK_PACKAGE_VERSION_PATCH "${SANITYPRINT_VERSION_PATCH}")
set (CPACK_PACKAGE_VERSION_EXTRA "${PROJECT_VERSION_EXTRA}")
set (CPACK_PACKAGE_FILE_NAME "${PROCESS_NAME}_${SANITYPRINT_VERSION}_${PROJECT_VERSION_EXTRA}")
set (CPACK_PACKAGE_DESCRIPTION_SUMMARY "Sanity Print is an open source slicer for FDM printers")
...
#     CreateShortCut \\\"$DESKTOP\\\\SanityPrint.lnk\\\" \\\"$INSTDIR\\\\SanityPrint.exe\\\"
# ")
#去除图标的缓存
...
set (CPACK_PACKAGE_INSTALL_REGISTRY_KEY "SanityPrint-${SANITYPRINT_VERSION_MAJOR}")

set (CPACK_NSIS_EXECUTABLES_DIRECTORY ".")
# set (CPACK_NSIS_MODIFY_PATH "ON")
set(CPACK_PACKAGE_EXECUTABLES "SanityPrint;SanityPrint")
