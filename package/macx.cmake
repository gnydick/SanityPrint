set(App_Name SanityPrint.app)
set(BUNDLE_NAME SanityPrint)
set(App_Volumn_Name "Sanity Print App")
...
set(CPACK_PACKAGE_FILE_NAME "${PROCESS_NAME}-${SANITYPRINT_VERSION}-macx-${CMAKE_OSX_ARCHITECTURES}-${PROJECT_VERSION_EXTRA}")
