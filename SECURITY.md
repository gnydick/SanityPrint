...
The SanityPrint team and community take all security bugs in SanityPrint seriously. Thank you for improving the security of SanityPrint. We appreciate your efforts to disclose the issue responsibly, and will make every effort to acknowledge your contributions.
...
SanityPrint will confirm the problem and determine the affected versions.
SanityPrint will audit code to find any similar problems.
SanityPrint will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
...
SanityPrint security contact { contact: mailto:softfeverever@gmail.com] }
...
SanityPrint Checklist: Security Recommendations
Follow these steps to improve security when using SanityPrint.
