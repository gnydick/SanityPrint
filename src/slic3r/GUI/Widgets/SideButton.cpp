    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(26, 111, 163), StateColor::Pressed);
    border_color.append(wxColour(93, 173, 226), StateColor::Hovered);
    border_color.append(0x2E86C1, StateColor::Normal);
    ...
    background_color.append(wxColour(26, 111, 163), StateColor::Pressed);
    background_color.append(wxColour(93, 173, 226), StateColor::Hovered);
    background_color.append(0x2E86C1, StateColor::Normal);
