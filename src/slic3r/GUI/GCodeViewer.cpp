...
void GCodeViewer::render_all_plates_stats(const std::vector<const GCodeProcessorResult*>& gcode_result_list, bool show /*= true*/) const {
    ...
    ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(0.180f, 0.525f, 0.757f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_HeaderHovered, ImVec4(0.180f, 0.525f, 0.757f, 1.0f));
