...
// When parsing a configuration value, if the old_value is not understood by this SanityPrint version,
// it is being substituted with some default value that this SanityPrint could work with.
