...
macro(__build_rc_config)
  if(EXISTS ${CMAKE_SOURCE_DIR}/customized/${CUSTOM_TYPE}/msw/SanityPrint.rc.in)
    configure_file(${CMAKE_SOURCE_DIR}/customized/${CUSTOM_TYPE}/msw/SanityPrint.rc.in ${CMAKE_CURRENT_BINARY_DIR}/SanityPrint.rc @ONLY)
  endif()
endmacro()
macro(__build_manifest_config)
  if(EXISTS ${CMAKE_SOURCE_DIR}/customized/${CUSTOM_TYPE}/msw/SanityPrint.manifest.in)
    configure_file(${CMAKE_SOURCE_DIR}/customized/${CUSTOM_TYPE}/msw/SanityPrint.manifest.in ${CMAKE_CURRENT_BINARY_DIR}/SanityPrint.manifest @ONLY)
  endif()
endmacro()
